...
import (
	...
	"github.com/ovn-org/ovn-kubernetes/go-controller/pkg/crd/extnetworkpolicy/v1alpha1/apis/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type K8sV1alpha1Interface interface {
	RESTClient() rest.Interface
	ExtNetworkPoliciesGetter
}
...
func (c *K8sV1alpha1Client) ExtNetworkPolicies(namespace string) ExtNetworkPolicyInterface {
	return newExtNetworkPolicies(c, namespace)
}
